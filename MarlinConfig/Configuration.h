...
#define STRING_CONFIG_H_AUTHOR "J.R. Allen" // Who made the changes.
...
//Suppress auto-assigned LCD SERIAL PORT Warning
...
#define PIDTEMPBED
  ...
  // Ender-3 V2
  #define DEFAULT_bedKp 101.43
  #define DEFAULT_bedKi 17.86 
  #define DEFAULT_bedKd 384.09
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -46, -10.5, -3.5 }
